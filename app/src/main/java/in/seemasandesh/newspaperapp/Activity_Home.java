...
import static in.seemasandesh.newspaperapp.Globals.showAlertDialog;
...
public class Activity_Home extends SlidingFragmentActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		checkPermissions();
		/*context=this;
		String sign=Settings.getApplicationSignature(context);*/

		//if (Build.VERSION.SDK_INT >=23) {   checking if sdk is above 23 the ask for multiple permission
			//Log.i("gopal","Device build version-> "+Build.VERSION.SDK_INT);
		...
		switch (requestCode) {
			case REQUEST_CODE_ASK_PERMISSION:{
				...
				if(flag==1){
					...
					Globals.showAlertDialog("PERMISSION REQUIRED", "Please Go To App Setting In Your Mobile And ALLOW 'Permissions' To The App ".toUpperCase(), this, "APP SETTING", listenerPositive, "EXIT", listnerNegative, false);
				...
				/*if(grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED){
					...
					Log.i("gopal","denied Permissions -> "+deniedPermissions);
...
*/
	...
	*/
	...
	public void onBackPressed() {
		...
		showAlertDialog("Alert", "Do you really want to exit ?", this, "CANCEL", null, "EXIT", listnerNegative, true);
	}
