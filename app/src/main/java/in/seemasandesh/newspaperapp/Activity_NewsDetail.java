...
public class Activity_NewsDetail extends FragmentActivity implements
	...
	public void popupWindowShareNews()
	{
		View popupView = getLayoutInflater().inflate(R.layout.popup_layout_news_share, null);
				...
				case R.id.ivWhatsapp:
					...
					Picasso.with(getApplicationContext()).load(currentNewsItem.getImagePath()).into(new Target() {
						...
						public void onBitmapLoaded(Bitmap bitmap, Picasso.LoadedFrom from) {
							...
							if (isPackageInstalled("com.whatsapp", Activity_NewsDetail.this)) {
				...
				case R.id.ivFacebook:
					...
					shareIntent.putExtra
							(Intent.EXTRA_TEXT, currentNewsItem.getHeading() + "\n" + "Read more @\n"
									...
									getResources().getString(
											R.string.news_paper_name));
					shareIntent.putExtra(Intent.EXTRA_SUBJECT,"Seema Sandesh News");
					  shareIntent.setType("text/plain");

					if (isPackageInstalled("com.facebook.katana", Activity_NewsDetail.this)) {
				...
				case R.id.ivGmail:
					...
					Picasso.with(getApplicationContext()).load(currentNewsItem.getImagePath()).into(new Target() {
						...
						public void onBitmapLoaded(Bitmap bitmap, Picasso.LoadedFrom from) {
							...
							if (isPackageInstalled("com.google.android.gm", Activity_NewsDetail.this)) {
				...
				case R.id.ivTwitter:
					...
					Picasso.with(getApplicationContext()).load(currentNewsItem.getImagePath()).into(new Target() {
						...
						public void onBitmapLoaded(Bitmap bitmap, Picasso.LoadedFrom from) {
							...
							if (isPackageInstalled("com.twitter.android", Activity_NewsDetail.this)) {
